...
Firstly, we start by running Random-Effects Two-Level Model, which is a commonly used model for meta-analyses, assuming different studies included have different true effects.
...
png(filename = "forestall.png",
    width = 2000, height = 1750, res = 135)
